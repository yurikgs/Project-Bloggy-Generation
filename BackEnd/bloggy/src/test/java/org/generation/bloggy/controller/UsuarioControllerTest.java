...
public class UsuarioControllerTest {
	...
	void deveCriarUmNovoUsuario () {
		...
		HttpEntity<Usuario> requisicao = new HttpEntity<Usuario>(new Usuario(0L, 
				"Chapolin", "Ch@polin", "senhaforte", "foto", "normal"));
	...
	public void deveAtualizarUmUsuario() {
		...
		Optional<Usuario> usuarioCreate = usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Peter Parker", "spider@man.com", "aracnofobi@", "foto", "normal"));
	...
	public void deveMostrarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Carol Danvers", "captain@marvel.com", "thorIsWeak", "foto", "normal"));
		
		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Bruce Wayne", "batman@forever.com", "noNeedSuperPower", "foto", "normal"));
