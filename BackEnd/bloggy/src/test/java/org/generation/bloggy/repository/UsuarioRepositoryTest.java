...
public class UsuarioRepositoryTest {
	...
	void start () {
		...
		usuarioRepository.save(new Usuario(0L, "Yuri Silva", "yurikgs@outlook.com", "senhaforte", "foto", "normal"));
		usuarioRepository.save(new Usuario(0L, "Bruce Wayne", "Batman@batman.com", "senhaforte", "foto", "normal"));
		usuarioRepository.save(new Usuario(0L, "Diana Prince", "mulher@maravilha.com", "senhaforte",  "foto", "normal"));
	}	
