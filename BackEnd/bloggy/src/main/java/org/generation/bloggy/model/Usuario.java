...
public class Usuario {
	...
	@Schema(example = "email@email.com") //Como adicionar + de um modelo?
	@Email
	...
	public Usuario(long id,
			...
			@NotBlank(message = "O atributo senha é obrigatório") @Size(min = 5, message = "Atenção! Senha menor do que o permitido") String senha, String foto, String tipo) {
		super();
		this.id = id;
		this.nome = nome;
		this.email = email;
